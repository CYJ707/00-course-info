...
d(Xi,X0)= (Xi1−0) 2+(X i2−0) 2+(Xi3 −0) 2= Xi12+Xi22+Xi32
​	
...
For K=1, we look for the single nearest neighbour with the smallest distance. Observation 5 has the smallest distance ( 
2

​	
 ≈1.414) to the test point, and its class label is Green. Therefore, Observation 5 decides the prediction, which is Green.
