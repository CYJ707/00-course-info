...
The test point is X0=(0,0,0). The Euclidean distance formula is:
...
For K=1, we look for the single nearest neighbour with the smallest distance. Observation 5 has the smallest distance ( 2≈1.414) to the test point, and its class label is Green. Therefore, Observation 5 decides the prediction, which is Green.
...
1.Obs. 5 (Distance =2≈1.414, Class = Green)
2.Obs. 6 (Distance =3≈1.732, Class = Red)
